            ...
            <a href="#"
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 7H17M17 7V17M17 7L7 17" stroke="#0F1017" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" class="group-hover:stroke-secondary transition-colors duration-300" />
                </svg>
        ...
        <div class="lg:hidden">
            <button id="mobile-menu-button" class="focus:outline-none">
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M28.3337 9.91699H5.66699M28.3337 17.0003H5.66699M28.3337 24.0837H5.66699" stroke="#F1F3F4"
