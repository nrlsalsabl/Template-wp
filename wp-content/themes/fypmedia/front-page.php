...
<body <?php body_class(); ?>>
    ...
    <section class="relative mt-16 lg:mt-20">
        ...
        <div class="container-primary mt-11 flex flex-col lg:flex-row lg:justify-between lg:gap-10 lg:mt-20">
            ...
            <div class="mt-8 lg:mt-0 lg:max-w-96">
                <p class="text-secondary font-medium sm:text-lg lg:text-xl">Siap bantu bikin konten keren dan naikin
                    pamor
                   ...
                   flex flex-col"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/image.png" alt="
                                ...
                                <div class="px-4 py-7 flex flex-col grow">
                                    ...
                                    <p class="font-medium text-secondary mt-5 grow">
                                        Crafting digital experience where beauty meets ROI, turning heads and unlocking
                                        revenue
                        ...
                        while ($news_query->have_posts()):
                            ...
                            <article class="overflow-hidden transition-transform transform hover:scale-105">
                                ...
                                <div class="pt-4">
                                    ...
                                    <p class="text-primary-red text-xs">By <?php echo $post_author; ?> -
                                        <?php echo $post_date; ?>
                                    </p>
                                </div>
                            </article>
    ...
    <?php
    include "layouts/call-to-action.php";
