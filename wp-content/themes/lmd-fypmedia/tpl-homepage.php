...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1786487372567320"
...
<!--				<div class="col-lg-4 col-match-height"><div class="catlogo text-center mb-4"><a href="?php echo $link; ?>" title="<?php echo $title; ?>"><img src="?php echo $img; ?" alt="<php echo $title; ?>" class="lazyload img-fluid mx-auto rounded-3" /></a></div></div>-->
...
<!--?php endif; ?>-->
	...
	<div class="home-carousel3">
		<div class="container overflow-hidden py-5">
			...
			<div class="home-artikel-header d-flex align-items-center mb-3">
				<div class="dfl flex-grow-1"><h1 class="home-artikel-title h4 fh fc-pink fw-semibold text-uppercase mb-0"><span><?php echo lmd_get_mod('hcar3_title', 'Artikel Pilihan'); ?></span></h1></div>
